...
public class HealthyFoodAdapter extends RecyclerCommonAdapter<HealthyFoodBean.RowsBean> {
    DailyRecipeChildAdapter childAdapter;
    private List<String> dummyData;

    public HealthyFoodAdapter(Context context, List<HealthyFoodBean.RowsBean> datas) {
        super(context, R.layout.healthy_food_item, datas);
    }

    @Override
    public void convert(ViewHolder holder, HealthyFoodBean.RowsBean t, int position) {
