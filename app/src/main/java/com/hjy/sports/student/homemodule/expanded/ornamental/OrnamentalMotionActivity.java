 ...
 */
public class OrnamentalMotionActivity extends BaseActivity implements SurfaceHolder.Callback, View.OnClickListener, MediaPlayer.OnCompletionListener,
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        OrListBean actionsBean = (OrListBean) getIntent().getExtras().getSerializable("actionsBean");
        mPosition = getIntent().getExtras().getInt("position");
        data = actionsBean.getData();
...
//            mediaPlayer.prepare();
    ...
    public void onBufferingUpdate(MediaPlayer mp, int percent) {
        L.e("TAG", "onBufferingUpdate" + ",percent:" + percent);
    }
