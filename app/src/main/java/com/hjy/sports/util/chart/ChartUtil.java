...
public class ChartUtil {
    ...
    public static void showChart(Context context, LineChart lineChart, List<String> xDataList,
        ...
        CustomMarkerView mv = new CustomMarkerView(context, R.layout.radar_markerview);
        // set the marker to the chart
        lineChart.setMarkerView(mv);
        // 是否在折线图上添加边框
        lineChart.setDrawBorders(true);
        // 曲线描述 -标题
        lineChart.setContentDescription(title);
        // 标题字体大小
...
//        lineChart.setNoDataTextDescription("暂无数据");
    ...
    private static LineData setLineData(Context context, List<String> xDataList, List<Entry> yDataList,
        ...
        // 圆形的颜色
        lineDataSet.setCircleColor(context.getResources().getColor(R.color.login));
        // 高亮的线的颜色
        lineDataSet.setHighLightColor(Color.YELLOW);
        // 设置坐标点的颜色
        lineDataSet.setFillColor(context.getResources().getColor(R.color.login));
        // 设置坐标点为空心环状
